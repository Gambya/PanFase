...
namespace PanFASE
{
    public partial class TelaUpdateProduto : Form
    {
        ...
        public TelaUpdateProduto(Produto prod)
        {
            InitializeComponent();
            this.Produtos = prod;
        }
        ...
        {
            this.mtb_CodigoProdEdit.Text = Convert.ToString(this.Produtos.Codigo);
            this.tb_NomeProdutoEdit.Text = this.Produtos.Nome;
            this.tb_ValorProdEdit.Text = string.Format("{0:c}", this.Produtos.Valor);
            this.mtb_QtdEdit.Text = string.Format("{0:N2}", this.Produtos.Estoque);
        }
    }
}
